...
import { Truck, Mail, Lock, User, ShieldCheck, Loader2, AlertCircle, ArrowRight } from 'lucide-react';
            ...
            <div className="min-h-screen pt-32 pb-12 flex items-center justify-center px-4">
                ...
                >
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight mb-2">Join FleetFlow</h1>
                        <p className="text-slate-500">Create your enterprise account today.</p>
                    </div>
                    ...
                    <div className="bg-white border border-slate-200 p-8 rounded-[2.5rem] shadow-premium relative z-10">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="btn btn-primary w-full py-4 text-lg mt-4 group"
                            >
                                {loading ? (
                        ...
                        <div className="text-center mt-8">
                            <p className="text-slate-500 text-sm">
                                ...
                                <Link to="/login" className="text-primary-600 font-bold hover:text-primary-500 hover:underline underline-offset-4 transition-all">
                                    Sign In
                                </Link>
                            </p>
                        </div>
                    ...
                    <p className="text-center mt-10 text-slate-400 text-xs">
                        &copy; {new Date().getFullYear()} FleetFlow Inc. Secure Enterprise Registration.
                    </p>
                </motion.div>
            </div>
        </div>
